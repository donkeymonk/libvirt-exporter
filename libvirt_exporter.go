...
var (
	...
	libvirtDomainInfoMaxMemBytesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "uuid", "instance_name", "project_name"},
		nil)
	...
	libvirtDomainVcpuTimeDesc = prometheus.NewDesc(
		...
		[]string{"domain", "uuid", "instance_name", "project_name", "vcpu"},
		nil)
	...
	libvirtDomainMetaBlockDesc = prometheus.NewDesc(
		...
		[]string{"domain", "uuid", "instance_name", "project_name", "target_device", "source_file", "serial", "bus", "disk_type", "driver_type", "cache", "discard"},
		nil)
	libvirtDomainBlockRdBytesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "uuid", "instance_name", "project_name", "target_device"},
		nil)
	...
	libvirtDomainMetaInterfacesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "uuid", "instance_name", "project_name", "source_bridge", "target_device", "virtual_interface"},
		nil)
